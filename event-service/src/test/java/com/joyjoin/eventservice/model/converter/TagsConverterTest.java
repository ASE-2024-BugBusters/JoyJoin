...
public class TagsConverterTest {
    ...
    @ParameterizedTest
    @MethodSource
    void TestConvertToEntityAttribute(String from, List<Tag> expected) {
    ...
    static Stream<Arguments> TestConvertToEntityAttribute() {
        return Stream.of(
                ...
                arguments(" \t\r\n", List.of()),
                arguments("[]", List.of()),
                arguments("[\"VeganCuisine\"]", List.of(Tag.VeganCuisine)),
                arguments("[\"Basketball\",\"HealthyEating\"]", List.of(Tag.Basketball, Tag.HealthyEating))
        );
    }

    @ParameterizedTest
    @MethodSource
    void TestConvertToDatabaseColumn(List<Tag> from, String expected) {
    ...
    static Stream<Arguments> TestConvertToDatabaseColumn() {
        return Stream.of(
                arguments(List.of(), "[]"),
                arguments(List.of(Tag.VeganCuisine), "[\"VeganCuisine\"]"),
                arguments(List.of(Tag.Basketball, Tag.HealthyEating), "[\"Basketball\",\"HealthyEating\"]")
        );
    }
}
